  ...
  "flex h-auto cursor-text items-center justify-center gap-2 py-1.5 text-sm font-medium select-none [&>svg:not([class*='size-'])]:size-4 [&>kbd]:rounded-[calc(var(--radius)-5px)] group-data-[disabled=true]/input-group:opacity-50",
  {
    variants: {
      align: {
        ...
        'inline-end': 'order-last pr-1.5 has-[>kbd]:mr-[-0.35rem]',
        'block-start':
          'order-first w-full justify-start px-5 pt-5 [.border-b]:pb-5 group-has-[>input]/input-group:pt-2.5',
        'block-end':
          'order-last w-full justify-start px-5 pb-5 [.border-t]:pt-5 group-has-[>input]/input-group:pb-2.5',
      },
    },
    defaultVariants: {
      align: 'inline-start',
...
function InputGroupInput({ className, ...props }: React.ComponentProps<'input'>) {
  return (
    <Input
      ...
      className={cn(
        'bg-input dark:bg-input flex-1 rounded-none border-0 border-r-0 border-l-0 shadow-none focus-visible:ring-0',
        className,
      )}
      {...props}
    />
